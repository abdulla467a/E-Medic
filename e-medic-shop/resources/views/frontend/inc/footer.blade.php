...
<!--                <a target="_blank" class="text-reset border-left text-center p-4 d-block" href="{{ route('terms') }}">-->
<!--                    <i class="la la-file-text la-3x text-primary mb-2"></i>-->
<!--                    <h4 class="h6">{{ translate('Terms & conditions') }}</h4>-->
<!--                </a>-->
<!--            </div>-->
<!--            <div class="col-lg-3 col-md-6">-->
<!--                <a target="_blank" class="text-reset border-left text-center p-4 d-block" href="{{ route('returnpolicy') }}">-->
<!--                    <i class="la la-mail-reply la-3x text-primary mb-2"></i>-->
<!--                    <h4 class="h6">{{ translate('Return Policy') }}</h4>-->
<!--                </a>-->
<!--            </div>-->
<!--            <div target="_blank" class="col-lg-3 col-md-6">-->
...
<!--            </div>-->
<!--            <div class="col-lg-3 col-md-6">-->
<!--                <a target="_blank" class="text-reset border-left border-right text-center p-4 d-block" href="{{ route('privacypolicy') }}">-->
                ...
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        @if ( get_setting('widget_one_labels') !=  null )
                            ...
                            <li class="mb-2">
                                <a target="_blank" href="{{ json_decode( get_setting('widget_one_links'), true)[$key] }}" class="opacity-50 hov-opacity-100 text-reset">
                                    {{ $value }}
                                </a>
                            </li>
                            @endforeach
            ...
            <div class="col-md-4 col-lg-2">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        @endif
                        <li class="mb-2">
                            <a target="_blank" class="opacity-50 hov-opacity-100 text-reset" href="{{ route('purchase_history.index') }}">
                                {{ translate('Order History') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a target="_blank" class="opacity-50 hov-opacity-100 text-reset" href="{{ route('wishlists.index') }}">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <ul class="list-inline my-3 my-md-0 social colored text-center">
                    ...
                    <li class="list-inline-item">
                        <a target="_blank" href="{{ get_setting('instagram_link') }}" target="_blank" class="instagram"><i class="lab la-instagram"></i></a>
                    </li>
                    @endif
                    @if ( get_setting('youtube_link') !=  null )
                    <li class="list-inline-item">
                        <a target="_blank" href="{{ get_setting('youtube_link') }}" target="_blank" class="youtube"><i class="lab la-youtube"></i></a>
                    </li>
                    @endif
                    @if ( get_setting('linkedin_link') !=  null )
                    <li class="list-inline-item">
                        <a target="_blank" href="{{ get_setting('linkedin_link') }}" target="_blank" class="linkedin"><i class="lab la-linkedin-in"></i></a>
                    </li>
                    @endif
                </ul>
            </div>
