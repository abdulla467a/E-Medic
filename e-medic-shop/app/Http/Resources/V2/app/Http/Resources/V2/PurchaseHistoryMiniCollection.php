        ...
        return [
            'data' => $this->collection->map(function($data) {
                return [
                    ...
                    'delivery_status_string' => $data->delivery_status == 'pending'? "Order Placed" : ucwords(str_replace('_', ' ',  $data->orderDetails->first()->delivery_status)),
                    'grand_total' => format_price($data->grand_total) ,
                    'margin' => format_price($data->profit_margin) ,
